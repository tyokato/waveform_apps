...
class GelombangGangguanKabel extends StatelessWidget {
  const GelombangGangguanKabel({super.key});
...
class TitleGelombangGangguanKabel extends StatelessWidget {
  const TitleGelombangGangguanKabel({super.key});
