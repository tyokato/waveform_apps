...
class GelombangGangguanHewan extends StatelessWidget {
  const GelombangGangguanHewan({super.key});
...
class TitleGelombangGangguanHewan extends StatelessWidget {
  const TitleGelombangGangguanHewan({super.key});
