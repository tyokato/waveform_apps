...
class GelombangGangguanPetir extends StatelessWidget {
  const GelombangGangguanPetir({super.key});
...
class TitleGelombangGangguanPetir extends StatelessWidget {
  const TitleGelombangGangguanPetir({super.key});
